    ...
    return (
        <div className="stack-large">
            <div className="stack-small">
                <h2 style={{ fontSize: '24px' }}>Build Track: Final Proof</h2>
                <p style={{ opacity: 0.7 }}>Review your track progress and submit your project links.</p>
            </div>
...
export default BuildTrackProof;
